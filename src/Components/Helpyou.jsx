    ...
    return (
        <>
            <section className='position-relative'>
                ...
                <Container className='pt-md-5 pb-5 position-relative'>
                    <Row className='justify-content-center align-items-center pt-lg-5 pt-0 pb-lg-5 pb-0 mb-lg-5 mb-0 mt-5'>
                        <Col lg={6} data-aos="fade-right order-lg-first order-last">
                        ...
                        <Col lg={6} className='order-lg-last order-first' data-aos="fade-left">
                            <div>
