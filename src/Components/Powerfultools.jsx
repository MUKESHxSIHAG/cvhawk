                  ...
                  <Row className='justify-content-center align-items-center pt-3 pb-5'>
                      <Col lg={6} data-aos="fade-right">
                          <div className='d-flex flex-column justify-content-start align-items-start'>
                              ...
                              <p className='ff-primary fs-16 fc-black fw-400 opacity-75 max-w-525'>Customize your CV to reflect your <span className='fw-600'>unique personality</span> and professional brand. Choose from a wide range of <span className='fw-600'> professionally designed</span> templates and layouts, allowing you to find the <span className='fw-600'>perfect style</span> that aligns with your industry and career goals.</p>
                          </div>
                      </Col>
